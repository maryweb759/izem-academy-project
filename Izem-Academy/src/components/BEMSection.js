        ...
        <div className="w-full md:w-1/2 text-right flex flex-col justify-between h-full">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-relaxed">
              ...
              <span className="text-mainRed">4 مواد </span>
            ...
            <p className="font-inter text-secondDarkColor text-sm lg:text-base font-normal mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0 lg:mr-0">
              تحتوي منصة إيزم أكاديمي على صفحة خاصة بطلبة السنة الرابعة متوسط والتي فيها كل مايحتاجه الطالب
            </p>
          ...
          <button className="bg-primary text-white my-4 px-8 py-4 rounded-full text-lg font-semibold hover:primary-hover transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
            سجل في الدورة الآن →
          </button>
        </div>
